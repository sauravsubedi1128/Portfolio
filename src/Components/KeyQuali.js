function Keyquali (){
  return (
    <div className="mb-1">
    <div>
      <h1 className="bg-slate-700  h-[40px] w-[100%] p-3 font-bold text-white uppercase"> Key Qualification</h1>
      </div>
...
<li>Thrives on challenges, particularly in implementing and developing new initiatives. </li>
